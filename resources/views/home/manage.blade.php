    ...
    <div class="row justify-content-center">
        ...
        <form class="form-inline" method="GET" action="/home">
            ...
            <div class="card" style="width: 240px;">
                ...
                <div class="card-body">
                    <a href="/show-figure/{{$figure->figure_id}}}">
                        <h5 class="card-title">
                            {{$figure->figure_name}}
                        </h5>
                    </a>
                    ...
                    <p class="card-text"><small class="text-muted">{{$figure->category_name}}</small></p>
                    @if(Auth::check())
                        @if(Auth::user()->isUser())
                            <a href="/create-cart/{{$figure->figure_id}}/{{$figure->stock}}" class="btn btn-primary">Add to Cart</a>
                        @endif
                    @endif
                </div>
            </div>
